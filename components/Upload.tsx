...
const Upload = ({ onComplete }: UploadProps) => {
    ...
    const authPromptTimeoutRef = useRef<NodeJS.Timeout | null>(null);
    ...
    const requestSignIn = useCallback(() => {
        setAuthPrompt("First login, then use upload.");
        ...
        <div className="upload">
            {!file ? (
                ...
                >
                    ...
                    {authPrompt && (
                        <div className="upload-notify" role="status" aria-live="polite">
                            {authPrompt}
                        </div>
                    )}
                </div>
